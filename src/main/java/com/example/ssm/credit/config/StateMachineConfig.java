...
public class StateMachineConfig extends StateMachineConfigurerAdapter<PaymentState, PaymentEvent> {
    ...
    public void configure(StateMachineStateConfigurer<PaymentState, PaymentEvent> states) throws Exception {
        states.withStates()
                .initial(PaymentState.NEW) // Our initial state of our state machine
                .states(EnumSet.allOf(PaymentState.class)) // Load all states into our system
                .end(PaymentState.AUTH) // Happy path: When the hit auth indicates the end
                .end(PaymentState.PRE_AUTH_ERROR) // Sad path
